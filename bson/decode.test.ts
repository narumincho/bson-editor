  ...
  assertEquals(
    bsonBinaryToStructuredBson(
      new Uint8Array([
        ...
        0x02,
        // name (long)
        0x6c, 0x6f, 0x6e, 0x67, 0x00,
        // value (サンプルテキスト)
        0x19, 0x00, 0x00, 0x00, 0xe3, 0x82, 0xb5, 0xe3, 0x83, 0xb3, 0xe3, 0x83,
        0x97, 0xe3, 0x83, 0xab, 0xe3, 0x83, 0x86, 0xe3, 0x82, 0xad, 0xe3, 0x82,
        0xb9, 0xe3, 0x83, 0x88, 0x00,
        // document end
        0x00,
      ])
    ),
